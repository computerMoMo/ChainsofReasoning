...
entity_type_vocab_file = 'movie_vocab/entity_type_id.txt'
relation_vocab_file = 'movie_vocab/all_relation_id.txt'
entity_vocab_file = 'movie_vocab/all_entity_id.txt'
entity_type_map_file = 'movie_vocab/entity_to_type.txt'
label_vocab_file = 'movie_vocab/domain-label'
